...
@WebServlet(name = "ServletMiePrenotazioni", urlPatterns = {"/ServletMiePrenotazioni"})
public class ServletMiePrenotazioni extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String l = JSONMan.serializeJson(new Prenotazione("idPrenotazione", "idUtente", "idDocente", "idCorso", "Orario", "Data") );
