...
@WebServlet(name = "ServletJSONMateria", urlPatterns = {"/ServletJSONMateria"})
public class ServletJSONMateria extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String s = JSONMan.serializeJson(new Materia("TitoloCorso"));
        request.setAttribute("info", s);


        ArrayList<Materia> ar = DAO.MateriaDB();
